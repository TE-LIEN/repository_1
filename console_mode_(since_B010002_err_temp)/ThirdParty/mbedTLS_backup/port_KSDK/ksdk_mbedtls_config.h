...
//#if defined SENSMINI_Q1 || defined TCP_CLIENT_CFG_MBEDTLS_ENABLE

#define MBEDTLS_ENTROPY_HARDWARE_ALT	//turn on if use Trust M
	...
	#define SDK_ALIGN(var, alignbytes) __attritube__ ((align(alignbytes))) var
