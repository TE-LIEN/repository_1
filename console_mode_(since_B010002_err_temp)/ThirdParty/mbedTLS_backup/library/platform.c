...
#if defined SESNMINIA4 || defined SENSMINIA4_PLUS
#include <mqx.h>
#endif
...
static void *platform_calloc_uninit( size_t n, size_t size )
{
    ...
    //((void) size);
    //return( NULL );
  //return _mem_alloc_system_zero(n*size+32);
  //return _mem_alloc_system_zero(n*size);
  return SENS_MEM_ZALLOC(n*size);
