...
//#define NUVOTON_TEST_ALL_SOFTWARE
//#define TEST_SOFTWARE_CRYPT	//for test use

//#define MBEDTLS_V3_1

#define TCP_CLIENT_CFG_MBEDTLS_ENABLE	1


#ifndef TEST_SOFTWARE_CRYPT
#define ENABLE_NUVOTON_ECP_ALT
#endif

#ifndef NUVOTON_TEST_ALL_SOFTWARE
#define MBEDTLS_ENTROPY_HARDWARE_ALT
	...
	//#define SDK_ALIGN(var, alignbytes) _Pragma("data_alignment=8") var
	//#define SDK_ALIGN(var, alignbytes) __align(alignbytes) var
	#if defined SENSMINIA4 || defined SENSMINIA4_PLUS
	#define SDK_ALIGN(var, alignbytes) __attritube__ ((aligned(alignbytes))) var
	#elif defined SENSMINIA4_NEO || defined SENSMINIA4_PRO
	//#define SDK_ALIGN(var, alignbytes) ALIGN(alignbytes) var
...
#define MBEDTLS_PLATFORM_STD_EXIT	myMbedTlsExit
#endif

#if !defined(__OPTIMIZE__)	//yushun remove test optimization
...
#if 0
#include <stdarg.h>
	extern int platform_printf_uninit( const char *format, ... );
	extern int platform_fprintf_uninit( void *stream, const char *format, ... );
	extern int platform_vsnprintf_uninit( char * s, int n, const char * format, va_list arg );
	extern int platform_snprintf_uninit( char * s, int n, const char * format, ... );
	#define MBEDTLS_PLATFORM_NO_STD_FUNCTIONS
	#define MBEDTLS_PLATFORM_PRINTF_MACRO				platform_printf_uninit
	#define MBEDTLS_PLATFORM_SNPRINTF_MACRO			platform_snprintf_uninit
	#define MBEDTLS_PLATFORM_FPRINTF_MACRO			platform_fprintf_uninit
	#define MBEDTLS_PLATFORM_VSNPRINTF_MACRO		platform_vsnprintf_uninit
#endif
	...
	#define YUSHUN_TEST_NO_RSA	0

	#if !YUSHUN_TEST_NO_RSA
	//#define MBEDTLS_RSA_ALT	//currently Trust M can not use
	#endif
	
	//#define MBEDTLS_SEND_DBG_MSG
	//#define MBEDTLS_DISPLAY_CRYPTO_TIME
	//#define MBEDTLS_DISPLAY_CLIENT_CONNECT
	
#ifdef MBEDTLS_DISPLAY_CRYPTO_TIME
	extern long systemTickGet(void);
#endif
	
	extern void appDbgMsg(char *format, ...);
	#define mbedtlsDbgMsg	appDbgMsg
	
	
//NUVOTON EXAMPLE CONFIG
#ifdef ENABLE_NUVOTON_ECP_ALT
...
//NUVOTON EXAMPLE CONFIG
	...
	//try use no TrustM end
	
	//#define MBEDTLS_ECDSA_DETERMINISTIC	//trust-m disable
	//#define MBEDTLS_SSL_CBC_RECORD_SPLITTING

	//disable UDP TLS start
...
/* Define ALT functions. */
  ...
  #define MBEDTLS_AES_DECRYPT_ALT
	...
	//#define MBEDTLS_CIPHER_MODE_OFB	//code not ready temp remove
  
  //#define MBEDTLS_AES_ALT_NO_256	//yushun add for test
...
#if defined(MBEDTLS_FREESCALE_LTC_AES_GCM) || defined(MBEDTLS_FREESCALE_LPC_AES_GCM) || defined(MBEDTLS_FREESCALE_CAAM_AES_GCM)
...
#define MBEDTLS_PLATFORM_MEMORY
#define MBEDTLS_PLATFORM_STD_CALLOC OSA_MEM_CALLOC
#define MBEDTLS_PLATFORM_STD_FREE vPortFree
/*
#else
...
//void            *_mem_alloc_system_zero(uint32_t);
//uint32_t        _mem_free(void *);

//#define MBEDTLS_PLATFORM_MEMORY
//#define MBEDTLS_PLATFORM_STD_CALLOC _mem_alloc_system_zero
//#define MBEDTLS_PLATFORM_STD_FREE _mem_free
 ...
 */
//#define MBEDTLS_HAVE_ASM	//yushun remove test optimization
...
//#define MBEDTLS_ECP_NO_FALLBACK	//copilot recommand
/* Support for Weierstrass curves with Jacobi representation */
...
#define MBEDTLS_ECP_DP_CURVE25519_ENABLED	//copilot recommend
 ...
 */
//#define MBEDTLS_KEY_EXCHANGE_RSA_PSK_ENABLED	//yushun remove for NO RSA
 ...
 */
//#define MBEDTLS_KEY_EXCHANGE_RSA_ENABLED	//yushun remove for NO RSA
 ...
 *
 */
//#define MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED	//yushun remove
 ...
 */
//#define MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED	//yushun remove
 ...
 */
//#define MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED	//yushun remove
 ...
 */
#ifndef MBEDTLS_V3_1
#define MBEDTLS_SSL_TRUNCATED_HMAC	//mbedTls 3.1 remove
#endif
 ...
 */
//#define MBEDTLS_X509_RSASSA_PSS_SUPPORT	//yushun remove for NO RSA
 ...
 */
//#define MBEDTLS_AESNI_C		//yushun remove test optimization
 ...
 */
#define MBEDTLS_GCM_C	//shun test	will no SHA384
 ...
 */
//#define MBEDTLS_PADLOCK_C	//yushun remove test optimization
 ...
 */
//#define MBEDTLS_RSA_C	//yushun remove
...
//#define MBEDTLS_PLATFORM_PRINTF_MACRO        PRINTF /**< Default printf macro to use, can be undefined */	//yushun remove
/* Note: your snprintf must correctly zero-terminate the buffer! */
