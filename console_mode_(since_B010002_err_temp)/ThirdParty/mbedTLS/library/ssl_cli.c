...
ecdh_calc_secret:
	...
	#ifdef MBEDTLS_DISPLAY_CRYPTO_TIME
				startTime = systemTickGet() - startTime;
		#ifdef MBEDTLS_SEND_DBG_MSG
				mbedtlsDbgMsg("ecdh Gen calc secret take %d ticks\r\n", startTime);
		#endif
	#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
						mbedtlsDbgMsg("%s", "TLS State :write client hello\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse server hello\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse certificate\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse server key exchange\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse certificate request\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse server hello done\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :write certificate\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :write client key exchange\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :write certificate verify\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :write change cipher spec\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :write finish\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse new session ticket\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse change cipher spec\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :parse finished\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :handshake: done\r\n");
#endif
...
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :handshake wrapup\r\n");
#endif
           mbedtls_ssl_handshake_wrapup( ssl );
#if defined MBEDTLS_DISPLAY_CLIENT_CONNECT && defined MBEDTLS_SEND_DBG_MSG
					mbedtlsDbgMsg("%s", "TLS State :handshake wrapup Done\r\n");
#endif
           break;
