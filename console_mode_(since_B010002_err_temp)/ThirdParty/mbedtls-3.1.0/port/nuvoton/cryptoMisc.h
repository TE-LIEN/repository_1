...
#define CRYPTO_AES_USE_M460_LIB
//#define CRYPTO_USE_M460_LIB


#define MBED_ALIGN(x)	__attribute__((aligned(x)))
//#define MBED_ALIGN(x)	__align(x)
...
extern int genEcdhPrivateKeyInKs(void);
...
typedef struct _PUBLIC_KEY_FROM_HOST
{	uint8_t *publicKey;
	uint16_t length;
	uint8_t keyType;
