...
typedef int (*MqttNetConnectCb)(void *context, char* host, word16 port, int timeout_ms);
...
typedef struct _MqttNet {
    void                *context;
    MqttNetConnectCb    wlofConnect;
    MqttNetReadCb       mobileRead;
    MqttNetWriteCb      mobileWrite;
