...
static const HTTPSRV_CONTENT_TABLE_ROW content_tbl[] = {
	...
	{sizeof("js") - 1, "js", HTTPSRV_CONTENT_TYPE_JS, false},	//non-use cache
    //{sizeof("css") - 1, "css", HTTPSRV_CONTENT_TYPE_CSS, true},
	{sizeof("css") - 1, "css", HTTPSRV_CONTENT_TYPE_CSS, false},	//non-use cache
	...
	{sizeof("html") - 1, "html", HTTPSRV_CONTENT_TYPE_HTML, false},	//non-use cache
 ...
 * use LWIP
 */
err_t sys_sem_new1( sys_sem_t *pxSemaphore, u8_t ucCount )
{
	(void) ucCount;
...
HTTPSRV_STRUCT *httpsrv_create_server(HTTPSRV_PARAM_STRUCT *params)
{
    ...
    error = sys_sem_new1(&server->ses_cnt, server->params.max_ses);
    if (error != ERR_OK)
    {
        goto EXIT;
    }
