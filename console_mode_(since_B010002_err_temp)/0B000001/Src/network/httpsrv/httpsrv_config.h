...
#define HTTPSRV_CFG_HTTP_SESSION_STACK_SIZE (4096)
#endif
...
#define HTTPSRV_CFG_HTTPS_SESSION_STACK_SIZE (8192)
#endif

/* Task priority.*/
#ifndef HTTPSRV_CFG_DEFAULT_PRIORITY
//#define HTTPSRV_CFG_DEFAULT_PRIORITY DEFAULT_THREAD_PRIO
#define HTTPSRV_CFG_DEFAULT_PRIORITY HTTP_SERVER_TASK_PRIORITY
#endif
...
#define HTTPSRV_CFG_DEFAULT_INDEX_PAGE "Master.html"
#endif
...
#define HTTPSRV_CFG_DEFAULT_SES_CNT  (50)
#endif
...
#define HTTPSRV_CFG_DEFAULT_URL_LEN (1024)
#endif
...
#if NCC_VERSION
#undef HTTPSRV_CFG_MBEDTLS_ENABLE
#define HTTPSRV_CFG_MBEDTLS_ENABLE 0
#endif
