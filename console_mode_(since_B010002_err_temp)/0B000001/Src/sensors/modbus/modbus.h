...
#include "sensors/modbus/modbus-version.h"
...
{	int nb_bits;
	...
	int start_input_registers_2;
	int nb_registers;
	int start_registers;
	uint8_t	is2SetsInputRegisters;
	uint8_t *tab_bits;
...
MODBUS_API int modbus_read_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest, uint8_t send);
MODBUS_API int modbus_read_input_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest, uint8_t send);
MODBUS_API int modbus_read_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest, uint8_t send);
MODBUS_API int modbus_read_input_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest, uint8_t send);
MODBUS_API int modbus_write_bit(modbus_t *ctx, int coil_addr, int status, uint8_t send);
MODBUS_API int modbus_write_register(modbus_t *ctx, int reg_addr, const uint16_t value, uint8_t send);
MODBUS_API int modbus_write_bits(modbus_t *ctx, int addr, int nb, const uint8_t *data);
MODBUS_API int modbus_write_registers(modbus_t *ctx, int addr, int nb, const uint16_t *data, uint8_t send);
...
MODBUS_API uint16_t bswap_16(uint16_t x);
MODBUS_API uint32_t bswap_32(uint32_t x);
