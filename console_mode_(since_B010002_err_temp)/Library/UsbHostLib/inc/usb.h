...
extern int  connect_device(UDEV_T *, const char *, int);	//yushun modify, for print func, line
...
extern int usbh_get_config_descriptor(UDEV_T *udev, uint8_t *desc_buff, int buff_len, int configIndex);	//yushun modify
...
extern int usbh_get_string_descriptor(UDEV_T *udev, int index, uint8_t *desc_buff, int buff_len);	//yushun add
