...
#define OHCI_PER_PORT_POWER                 /* OHCI root hub per port powered             */	//yushun test
...
#if defined ENABLE_ERROR_MSG || defined ENABLE_DEBUG_MSG || ENABLE_VERBOSE_DEBUG
#define USB_DBG_LOCK			debugLock
#define USB_DBG_UNLOCK			debugUnlock
#else
#define USB_DBG_LOCK()
#define USB_DBG_UNLOCK()
#endif


#ifdef ENABLE_ERROR_MSG
#define USB_error            dbgMsg2
#else
#define USB_error(...)
#endif

#ifdef ENABLE_DEBUG_MSG
	#define USB_debug            dbgMsg2
