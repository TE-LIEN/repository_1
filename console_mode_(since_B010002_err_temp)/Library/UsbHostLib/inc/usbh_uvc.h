 ...
 * @file     usbh_uvc.h
 * @version  V1.00
 * @brief    USB Host UVC class driver header file.
 *
...
#define MAX_UVC_XMIT_SIZE		3072    // 1536	 //512	//3072  //4608
...
#define UVC_MAX_FORMAT          24//12           /* Maximum number of video stream format supported in an UVC device.    */
...
#define UVC_UTR_PER_STREAM      16//4
// #define UVC_UTR_PER_STREAM      32
// #define IF_PER_UTR           8           /* defined in usb.h                        */
#define UVC_UTR_INBUF_SIZE      (IF_PER_UTR * MAX_UVC_XMIT_SIZE)
...
//#define UVC_DEBUG
//#define UVC_ERRMSG      dbgMsg2

#ifdef UVC_DEBUG
#define UVC_DBGMSG      dbgMsg2
#define UVC_ERRMSG      dbgMsg2
#else
#define UVC_DBGMSG(...)
#define UVC_ERRMSG(...)
...
/** @addtogroup N9H30_USBH_EXPORTED_STRUCTURES USBH Host Exported Structures
  @{
*/
